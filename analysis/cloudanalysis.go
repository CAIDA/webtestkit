...
func main() {
	var datapath string
	speedtestplatform := []string{"comcast","ookla","ndt"}
	...
	flag.StringVar(&datapath, "path", "/home/ubuntu/data/", "data path")
	...
	for _, nd := range nodes {
		for _, platform := range speedtestplatform {
			if cleanrun {
				gobsearch := datapath + "/" + nd + "/speedtest/outdir/softwares/speedtest/" + platform + "/" + "*.gob"
				...
				rtt_json_search := datapath + "/" + nd + "/speedtest/outdir/softwares/speedtest/" + platform + "/"  + "*rtt.json"
			...
			filesearch := datapath + "/" + nd + "/speedtest/outdir/softwares/speedtest/" + platform + "/" + "*.json"
